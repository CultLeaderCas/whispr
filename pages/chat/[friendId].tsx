...
export default function ChatPage() {
  ...
  return (
    <>
      {isLoading || !currentUser || !friendProfile ? (
        <div className="flex-1 flex items-center justify-center min-h-[calc(100vh-80px)]">
          <p className="text-white text-lg">{isLoading ? 'Loading chat...' : 'Error: Could not load chat data.'}</p>
        </div>
      ) : (
        <div className="max-w-[1440px] mx-auto pt-4 flex min-h-screen">
